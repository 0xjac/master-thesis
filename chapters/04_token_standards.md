...
While the drawbacks of ERC20 mentioned above appear to be poor design, an important factor when writing the standard was that tokens were already being used before the standard was finalized. The standard was therefore written in such a way that those first "ERC20" tokens would remain ERC20-compliant.
