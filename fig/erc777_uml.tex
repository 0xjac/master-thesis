...
\caption[\acrshort{uml} class diagram of the ERC777 Reference Implementation]{\acrshort{uml} class diagram of the ERC777 Reference Implementation, with the ERC820 dependency and an extra implementation using the \texttt{ERC777ERC20BaseToken}.}
\label{fig:erc777uml}
\end{figure}
