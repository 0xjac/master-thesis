...
\newfontfamily\cyrillicfont{libertinusserif-regular.otf}[Script=Cyrillic]
\newfontfamily\cyrillicfontsf{libertinussans-regular.otf}[Script=Cyrillic]
...
\usepackage[nomain,acronym,xindy={glsnumbers=false},toc,shortcuts]{glossaries}
\makeglossaries
\include{glossary}
