...
\newglossaryentry{gls-rlp}{
  ...
  description = {Recursive Length Prefix is the main serialization technique in Ethereum. It permits the encoding arbitrarily nested arrays of binary data and is used to encode structure and objects in Ethereum.}
}
